                                    ...
                                    <div className="prose max-w-none">
                                        ...
                                        {finalizedText ? (
                                            ...
                                            <p className="text-slate-300 leading-7 text-lg">
                                                {transcripts.map((t, i) => (
                                                    <span key={t.id || i} className="mr-1 hover:bg-white/5 transition-colors cursor-default" title={`Confidence: ${Math.round((t.confidence || 0) * 100)}% • ${t.timestamp}`}>
                                                        {t.text}
                                                    </span>
                                                ))}
                                            </p>
                            ...
                            <div className="absolute inset-0 overflow-y-auto p-4 space-y-4">
                                ...
                                {hints.map((h, idx) => (
                                    ...
                                    >
                                        ...
                                        <div className={`whitespace-pre-wrap text-sm leading-relaxed ${h.type === 'error' ? 'text-red-400' : 'text-slate-300'}`}>
                                            {h.hint || h.text}
                                        </div>
                                    </div>
                                ))}
